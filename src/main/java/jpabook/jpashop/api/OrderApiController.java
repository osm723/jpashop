...
//            order.getDelivery().getAddress();
//            List<OrderItem> orderItems = order.getOrderItems();
//            orderItems.stream().map(o -> new orderItemsDto(o)).collect(Collectors.toList());
//        }
        return result;
    }
    ...
    public List<OrderQueryDto> ordesV4() {
        return orderQueryRepository.findOrderQueryDtos();
    }

    @GetMapping("/api/v5/orders")
    public List<OrderQueryDto> ordesV5() {
        return orderQueryRepository.findAllByDto_optimaztion();
    }
    ...
    static class OrderDto {
        ...
        public OrderDto(Order order) {
            ...
            orderItem = order.getOrderItems().stream().map(orderItem -> new OrderItemDto(orderItem)).collect(toList());
        }
    }
